    ...
    return {
      ...
      link: function(scope, element, attr) {
        ...
        var player = videojs(id, {}, function() {
          ...
          this.src([{
            type: scope.videoList[0].type0,
            src: scope.videoList[0].src0 + now
          }, {
            type: scope.videoList[0].type1,
            src: scope.videoList[0].src1 + now
          }]);
          ...
          player.markers({
            ...
            onMarkerReached: function(marker) {
              if (marker) {
                $('.event-list').children().replaceWith("<a href='#' class='list-group-item activeX'><h4 class='list-group-item-heading'>" + marker.text + "</h4><p class='list-group-item-text'>data can be added here data can be added here data can be added here data can be added here data can be added here data can be added here </p></a>");
              }
            },
        ...
        window.onkeyup = function(e) {
          ...
          if (key == 37) {
            ...
            if (!isPaused) {
              player.pause();
              scope.markerAdd(); // TODO need data!!!
            }
            console.log("insert");
          }
        }
